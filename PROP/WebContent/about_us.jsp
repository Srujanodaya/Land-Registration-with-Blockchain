			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="col-md-12">
							We have started the Service since 2018, have enough experience in the Real estate business <br> <br>
						</div>
						<div class="col-md-8">We are committed to deliver thing in time.</div>
						<div class="col-md-4">
						...
						<br><br>
						<div class="col-md-12" >
							Focus is on customer goodness<br>
							<br>
						</div>
					</div>
